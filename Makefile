...
coverage:
	$(GO) test ./... -covermode=count \
		-coverpkg=./internal/syntax/...,./internal/ssaflow/...,./internal/ssainfer,./internal/heapmodel,./internal/catalog,./internal/check,./internal/flagvalue,./internal/trace,./internal/cli,./analyzers,./internal/passes/...,./internal/analyzers/...,./internal/docexamples,./plugin/golangci \
