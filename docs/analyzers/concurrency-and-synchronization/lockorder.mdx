...
budget cut is inconclusive. It does not attempt general cycles, WaitGroups, buffered
...
Both checks use the bounded synchronization graph to distinguish program order
