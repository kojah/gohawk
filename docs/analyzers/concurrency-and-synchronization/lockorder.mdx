...
exact snapshots, not their mutable cells; constructor results and receiver-slot
publication still need additional evidence and are not treated as fresh here.
