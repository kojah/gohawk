...
worker-select variants may be checked; every variant must prove the same
parent wait. Optional waits, early signals, and cancellation escapes defeat
that proof. Opaque whole-function summaries remain inconclusive even if a
