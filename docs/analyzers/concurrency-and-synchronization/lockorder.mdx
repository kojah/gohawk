...
| <CheckIdentity name="contradictory-order" tier="core" /> | hazard | core | Reports bounded cycles in mutex acquisition order, with acquisition and helper-call evidence. |
