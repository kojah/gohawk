...
| Check (`deferinloop/…`) | What it detects | Profile | Tags |
| --- | --- | --- | --- |
| `cleanup-lifetime` | Reports cleanup defers whose lifetime extends across loop iterations. | <CheckProfile profile="default" /> | <CheckTags tags={["reliability"]} /> |
