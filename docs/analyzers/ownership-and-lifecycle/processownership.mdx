...
| --- | --- | --- | --- |
| `processownership/missing-wait` | Reports successfully started commands that are neither waited on nor transferred. | <CheckProfile profile="default" /> | <CheckTags tags={["correctness"]} /> |
