...
| --- | --- | --- | --- |
| `cancellationownership/release` | Reports derived cancel functions that are neither called nor transferred on every return path. | <CheckProfile profile="default" /> | <CheckTags tags={["correctness"]} /> |
