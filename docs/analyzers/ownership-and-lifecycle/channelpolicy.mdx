...
| --- | --- |
| <CheckIdentity name="capacity-rationale" profile="opt-in" tags={["policy"]} /> | Reports large constant channel capacities without a nearby bounded rationale. |
| <CheckIdentity name="caller-close" profile="default" tags={["reliability","policy"]} /> | Reports functions that close channels received from their callers. |
| <CheckIdentity name="send-after-close" profile="default" tags={["correctness"]} /> | Reports sends reachable after a channel has been closed. |
