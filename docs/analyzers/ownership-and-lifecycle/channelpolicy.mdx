...
| --- | --- |
| <CheckIdentity name="capacity-rationale" optIn tags={["policy"]} /> | Reports large constant channel capacities without a nearby bounded rationale. |
| <CheckIdentity name="caller-close" tags={["reliability","policy"]} /> | Reports functions that close channels received from their callers. |
| <CheckIdentity name="send-after-close" tags={["correctness"]} /> | Reports sends reachable after a channel has been closed. |
