---
title: exitpolicy
seoTitle: "exitpolicy: Detect process exits that skip Go cleanup"
...
| --- | --- | --- | --- |
| <CheckIdentity name="skipped-defer" tier="extended" /> | hazard | extended | Reports immediate process termination that bypasses an earlier defer. |
