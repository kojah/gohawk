...
| Check (`exitpolicy/…`) | What it detects | Profile | Tags |
| --- | --- | --- | --- |
| `skipped-defer` | Reports immediate process termination that bypasses an earlier defer. | <CheckProfile profile="default" /> | <CheckTags tags={["correctness"]} /> |
