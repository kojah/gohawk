...
| Check (`resourcelifetime/…`) | What it detects | Profile | Tags |
| --- | --- | --- | --- |
| `missing-release` | Reports owned resources that are not released on every return path. | <CheckProfile profile="default" /> | <CheckTags tags={["correctness"]} /> |
