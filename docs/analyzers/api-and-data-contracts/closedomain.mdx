...
| --- | --- | --- | --- |
| `closedomain/closed-string-domain` | Reports exported string fields used as small closed sets of values. | <CheckProfile profile="default" /> | <CheckTags tags={["reliability","policy"]} /> |
