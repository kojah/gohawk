...
| --- | --- |
| <CheckIdentity name="keyed-literal" profile="default" tags={["reliability","policy"]} /> | Reports positional composite literals for persisted or wire structs. |
| <CheckIdentity name="serialization-tag" profile="default" tags={["reliability","policy"]} /> | Reports exported wire fields without explicit JSON or TOML tags. |
