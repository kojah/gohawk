...
| --- | --- | --- | --- |
| `wirepolicy/keyed-literal` | Reports positional composite literals for persisted or wire structs. | <CheckProfile profile="default" /> | <CheckTags tags={["reliability","policy"]} /> |
| `wirepolicy/serialization-tag` | Reports exported wire fields without explicit JSON or TOML tags. | <CheckProfile profile="default" /> | <CheckTags tags={["reliability","policy"]} /> |
