...
| --- | --- |
| <CheckIdentity name="keyed-literal" optIn /> | Reports positional composite literals for persisted or wire structs. |
| <CheckIdentity name="serialization-tag" optIn /> | Reports exported wire fields without explicit JSON or TOML tags. |
