...
| --- | --- | --- |
| <CheckIdentity name="keyed-literal" optIn /> | policy | Reports positional composite literals for persisted or wire structs. |
| <CheckIdentity name="serialization-tag" optIn /> | policy | Reports exported wire fields without explicit JSON or TOML tags. |
