...
| --- | --- |
| <CheckIdentity name="keyed-literal" tags={["reliability","policy"]} /> | Reports positional composite literals for persisted or wire structs. |
| <CheckIdentity name="serialization-tag" tags={["reliability","policy"]} /> | Reports exported wire fields without explicit JSON or TOML tags. |
