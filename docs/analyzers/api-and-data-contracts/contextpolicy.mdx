...
| --- | --- |
| <CheckIdentity name="context-first" profile="default" tags={["reliability","policy"]} /> | Reports context.Context parameters that are not first. |
| <CheckIdentity name="context-storage" profile="default" tags={["reliability","policy"]} /> | Reports context.Context values stored in structs. |
| <CheckIdentity name="test-context" profile="opt-in" tags={["policy"]} /> | Reports tests that use context.Background instead of the testing handle's context. |
| <CheckIdentity name="nil-context" profile="default" tags={["correctness"]} /> | Reports definitely nil context.Context arguments. |
