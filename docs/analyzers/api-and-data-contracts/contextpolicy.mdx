...
| --- | --- | --- |
| <CheckIdentity name="context-first" /> | policy | Reports misplaced context.Context parameters while allowing additional contexts after a leading context and one context after a testing handle. |
| <CheckIdentity name="context-storage" /> | policy | Reports context.Context values stored in structs. |
| <CheckIdentity name="nil-context" /> | defect | Reports definitely nil context.Context arguments. |
