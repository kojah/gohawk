...
| --- | --- |
| <CheckIdentity name="send" tags={["reliability"]} /> | Reports unguarded channel sends in context-aware test code. |
| <CheckIdentity name="receive" tags={["reliability"]} /> | Reports blocking channel receives in tests without a cancellation escape. |
| <CheckIdentity name="select" tags={["reliability"]} /> | Reports blocking selects in tests without a cancellation escape. |
