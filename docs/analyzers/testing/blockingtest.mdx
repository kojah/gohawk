...
| Check (`blockingtest/…`) | What it detects | Profile | Tags |
| --- | --- | --- | --- |
| `send` | Reports unguarded channel sends in context-aware test code. | <CheckProfile profile="default" /> | <CheckTags tags={["reliability"]} /> |
| `receive` | Reports blocking channel receives in tests without a cancellation escape. | <CheckProfile profile="default" /> | <CheckTags tags={["reliability"]} /> |
| `select` | Reports blocking selects in tests without a cancellation escape. | <CheckProfile profile="default" /> | <CheckTags tags={["reliability"]} /> |
