...
| --- | --- |
| <CheckIdentity name="send" profile="default" tags={["reliability"]} /> | Reports unguarded channel sends in context-aware test code. |
| <CheckIdentity name="receive" profile="default" tags={["reliability"]} /> | Reports blocking channel receives in tests without a cancellation escape. |
| <CheckIdentity name="select" profile="default" tags={["reliability"]} /> | Reports blocking selects in tests without a cancellation escape. |
