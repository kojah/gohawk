...
| --- | --- |
| <CheckIdentity name="send" optIn /> | Reports unguarded channel sends in context-aware test code. |
| <CheckIdentity name="receive" optIn /> | Reports blocking channel receives in tests without a cancellation escape. |
| <CheckIdentity name="select" optIn /> | Reports blocking selects in tests without a cancellation escape. |
