...
| Check (`testpolicy/…`) | What it detects | Profile | Tags |
| --- | --- | --- | --- |
| `helper-marker` | Reports test helpers that do not call Helper on every return path. | <CheckProfile profile="default" /> | <CheckTags tags={["policy"]} /> |
