...
For complete straight-line mutex helpers, shared concurrency summaries bind
...
A does. These sequences are used at the call site; they do not yet propagate
a helper's returned held-lock state into the caller's later instructions.
