...
| --- | --- | --- | --- |
| `syncmapatomicity/non-atomic-claim` | Reports separate sync.Map Load and Delete operations used to claim one value. | <CheckProfile profile="default" /> | <CheckTags tags={["correctness"]} /> |
