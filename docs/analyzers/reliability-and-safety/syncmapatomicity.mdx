...
seoTitle: "syncmapatomicity: Detect non-atomic sync.Map claims in Go"
...
| --- | --- | --- | --- |
| <CheckIdentity name="non-atomic-claim" tier="core" /> | hazard | core | Reports separate sync.Map Load and Delete operations used to claim one value. |
