...
| --- | --- | --- | --- |
| `oncepolicy/discarded-wrapper` | Reports sync.Once function wrappers that are called and immediately discarded. | <CheckProfile profile="default" /> | <CheckTags tags={["correctness"]} /> |
