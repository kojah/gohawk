...
| --- | --- | --- | --- |
| `taintpolicy/untrusted-sink` | Reports untrusted input that reaches a configured sensitive sink without validation. | <CheckProfile profile="default" /> | <CheckTags tags={["correctness","reliability"]} /> |
