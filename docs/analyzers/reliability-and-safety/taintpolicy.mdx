...
| --- | --- | --- | --- |
| <CheckIdentity name="untrusted-sink" tier="experimental" /> | hazard | experimental | Reports untrusted input that reaches a configured sensitive sink without validation. |
