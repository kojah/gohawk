...
| --- | --- |
| <CheckIdentity name="untrusted-sink" profile="default" tags={["correctness","reliability"]} /> | Reports untrusted input that reaches a configured sensitive sink without validation. |
