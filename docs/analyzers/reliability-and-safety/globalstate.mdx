...
| --- | --- | --- | --- |
| `globalstate/mutable-package-state` | Reports mutable package-level state without an explicit owner. | <CheckProfile profile="default" /> | <CheckTags tags={["reliability","policy"]} /> |
