...
| Check (`evalorder/…`) | What it detects | Profile | Tags |
| --- | --- | --- | --- |
| `operand-mutation` | Reports expressions whose later operand mutates a value read by an earlier operand. | <CheckProfile profile="default" /> | <CheckTags tags={["correctness"]} /> |
