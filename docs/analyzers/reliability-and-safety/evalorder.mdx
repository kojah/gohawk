...
| --- | --- |
| <CheckIdentity name="operand-mutation" profile="default" tags={["correctness"]} /> | Reports expressions whose later operand mutates a value read by an earlier operand. |
