...
| Check (`determinism/…`) | What it detects | Profile | Tags |
| --- | --- | --- | --- |
| `map-output-order` | Reports map iteration that reaches ordered output without explicit sorting. | <CheckProfile profile="default" /> | <CheckTags tags={["reliability"]} /> |
