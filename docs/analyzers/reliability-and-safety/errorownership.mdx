...
| <CheckIdentity name="text-classification" /> | Reports production code that classifies errors by matching their text. |
| <CheckIdentity name="mismatched-inline-error" /> | Reports inline error declarations whose condition checks a different error. |
