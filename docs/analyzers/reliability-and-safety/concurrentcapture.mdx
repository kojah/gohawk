...
| --- | --- | --- | --- |
| `concurrentcapture/shared-capture` | Reports repeatedly launched goroutines that mutate the same captured local. | <CheckProfile profile="default" /> | <CheckTags tags={["correctness"]} /> |
