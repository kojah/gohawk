...
| Check (`concurrentcapture/…`) | What it detects | Profile | Tags |
| --- | --- | --- | --- |
| `shared-capture` | Reports repeatedly launched goroutines that mutate the same captured local. | <CheckProfile profile="default" /> | <CheckTags tags={["correctness"]} /> |
