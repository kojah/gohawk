...
| [`evalorder`](evalorder/) | Checks later operands that mutate values evaluated earlier. |
...
| [`oncepolicy`](oncepolicy/) | Checks sync.Once function wrappers that are immediately discarded. |
| [`syncmapatomicity`](syncmapatomicity/) | Checks non-atomic sync.Map load-and-delete claims. |
