---
title: deferinloop
seoTitle: "deferinloop: Detect deferred cleanup in Go loops"
...
in the [deferinloop design notes](https://github.com/kojah/gohawk/blob/main/docs/development/analyzers/deferinloop.md).
...
| --- | --- | --- | --- |
| <CheckIdentity name="cleanup-lifetime" tier="core" /> | core | hazard | Reports cleanup defers whose lifetime extends across loop iterations. |
...
A resource stored in a collection that outlives the loop is not reported,
because the collection may keep it on purpose.
