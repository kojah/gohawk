...
parent does not cover an otherwise unowned return. Wrapped or merged parents
remain outside this boundary. Signal registrations still need their own stop
