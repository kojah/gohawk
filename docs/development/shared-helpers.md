...
Keep the doc comment as the contract: the index below regenerates from it, and
the architecture tests fail if a helper is missing from this page. Then add the
