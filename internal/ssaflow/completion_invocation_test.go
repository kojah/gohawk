...
func TestExactInvocationBudgetAndCache(t *testing.T) {
	...
	request := CompletionRequest{Instruction: findLaunch(t, fn), Target: fn.Params[0], InvokeTarget: true, Budget: NewSearchBudget(1)}
