...
Labels removed together with a retired check or contract, and the reasons, are
recorded in [retired precision labels](../../docs/development/decisions/retired-precision-labels.md).
