...
import (
	...
	"github.com/kojah/gohawk/internal/analyzers/apishape"
	"github.com/kojah/gohawk/internal/analyzers/cancellationownership"
	"github.com/kojah/gohawk/internal/analyzers/channelpolicy"
	"github.com/kojah/gohawk/internal/analyzers/closedomain"
	"github.com/kojah/gohawk/internal/analyzers/concurrentcapture"
	"github.com/kojah/gohawk/internal/analyzers/contextpolicy"
	"github.com/kojah/gohawk/internal/analyzers/deferinloop"
	"github.com/kojah/gohawk/internal/analyzers/determinism"
	"github.com/kojah/gohawk/internal/analyzers/errorownership"
	"github.com/kojah/gohawk/internal/analyzers/evalorder"
	"github.com/kojah/gohawk/internal/analyzers/exitpolicy"
	"github.com/kojah/gohawk/internal/analyzers/globalstate"
	"github.com/kojah/gohawk/internal/analyzers/goroutineownership"
	"github.com/kojah/gohawk/internal/analyzers/lockorder"
	"github.com/kojah/gohawk/internal/analyzers/oncepolicy"
	"github.com/kojah/gohawk/internal/analyzers/processownership"
	"github.com/kojah/gohawk/internal/analyzers/resourcelifetime"
	"github.com/kojah/gohawk/internal/analyzers/syncmapatomicity"
	"github.com/kojah/gohawk/internal/analyzers/taintpolicy"
	"github.com/kojah/gohawk/internal/analyzers/testpolicy"
	"github.com/kojah/gohawk/internal/analyzers/wirepolicy"
)
